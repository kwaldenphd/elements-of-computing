...
**Q1C: Develop a Python program that uses `plotly` plotting functions to generate at least three different plot types. Answer to this question includes code + comments.**
